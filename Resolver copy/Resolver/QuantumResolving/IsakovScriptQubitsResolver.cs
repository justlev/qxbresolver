...
{
    public class IsakovScriptQubitsResolver : IQubitsResolver<decimal>
    {
        ...
        public IEnumerable<IQubitsResolvingResponse> Resolve(IEnumerable<decimal> inputNumbers, IEnumerable<IBias<decimal>> biases, IEnumerable<ICoupling<decimal>> numToCouplings)
        {
        ...
        private IEnumerable<IQubitsResolvingResponse> ParseResult(string output)
        {
            ...
            for (var i = 0; i < splittedOutput.Length-2; i+=3)
            {
                ...
                {
                    bytes.Add(character == '+' ? (short)1 : (short)-1);
                }
        ...
        private void DumpToLatticeFile(IEnumerable<IBias<decimal>> biases, IEnumerable<ICoupling<decimal>> couplings)
        {
